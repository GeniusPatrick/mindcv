...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "When using webdataset, multiple datasources can be combined using the `::` separator."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--lr-cooldown-end", type=float, default=0.0, help="End learning rate for cooldown schedule. Default: 0"
    )
    parser.add_argument(
        "--lr-cooldown-power",
        type=float,
    ...
    parser.add_argument(
        "--report-to", default="", type=str, help="Options are ['wandb', 'tensorboard', 'wandb,tensorboard']"
    )
    ...
    parser.add_argument(
        "--coca-caption-loss-weight", type=float, default=2.0, help="Weight assigned to caption loss in CoCa."
    )
    parser.add_argument(
    ...
    parser.add_argument("--distill-model", default=None, help="Which model arch to distill from, if any.")
    parser.add_argument("--distill-pretrained", default=None, help="Which pre-trained weights to distill from, if any.")
    parser.add_argument("--siglip", default=False, action="store_true", help="Use SigLip (sigmoid) loss.")
